...
spr.set_voxel_area(0, vec3(0, 0, 0), vec3(63, 0, 63), mat_opaque_blue)
spr.set_voxel_area(0, vec3(9, 1, 3), vec3(13, 5, 7), mat_translucent)
spr.set_voxel_area(0, vec3(3, 1, 9), vec3(7, 5, 13), mat_light)
